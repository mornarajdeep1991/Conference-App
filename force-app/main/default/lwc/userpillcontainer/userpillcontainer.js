...
export default class Lookup extends NavigationMixin(LightningElement) {
    ...
    setSearchResults(results) {
        ...
        this.searchResultsLocalState = this._searchResults.map((result, i) => {
            return {
                ...
                get classes() {
                    let cls =
                        'slds-media slds-listbox_option slds-listboxoption_entity slds-listbox_option_has-meta';
    ...
    get getSearchIconClass() {
        let css = 'slds-input_icon slds-input_icon_right ';
        if (!this.isMultiEntry) {
    ...
    get getClearSelectionButtonClass() {
        return (
            'slds-button slds-button_icon slds-input_icon slds-input_icon_right ' +
